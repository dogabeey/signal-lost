export const GAME = {
  ...
  cellMinDistance: 3,
  chronoCellSpawnInterval: 20,
  chronoCellLifetime: 9,
...
export const DIFFICULTY = {
  ...
  sector9: {
    ...
    availableObstacleTypes: ['regular', 'chaser', 'poisonCreeper', 'banger', 'shooter', 'porter', 'magnet', 'spore'],
    maxActiveEnemies: 22,
    maxActiveEnemiesIncrementPerCell: 0.11,
    obstacleSpawnCountOffset: 9,
    obstacleSpawnCountIncreasePerCell: 0.14,
    obstacleSpawnIntervalOffset: -5.4,
    obstacleSpawnDecreasePerCellOffset: 0.09,
    obstacleLifetimeOffset: 12,
    obstacleLifetimeIncreasePerCellOffset: 0.17,
    regularSpawnWeight: 0.18,
    chaserSpawnWeight: 0.3,
    poisonCreeperSpawnWeight: 0.2,
    bangerSpawnWeight: 0.17,
    shooterSpawnWeight: 0.16,
    porterSpawnWeight: 0.14,
    magnetSpawnWeight: 0.14,
    sporeSpawnWeight: 0.14,
    availableFallingRockTypes: ['stoneRock', 'fieryRock', 'splinter'],
    fallingRockSpawnIntervalOffset: -26,
    fallingRockSpawnDecreasePerCellOffset: 0.18,
    stoneRockSpawnWeight: 0.1,
    fieryRockSpawnWeight: 0.56,
    splinterSpawnWeight: 0.34,
  },
}
export const COLORS = {
  background: '#101b25',
  ...
  player: '#67d46e',
  playerEmissive: '#1d7437',
  playerWing: '#9af08f',
  playerWingEmissive: '#2f8b42',
  playerRing: '#d7ffb8',
  cell: '#63f5cd',
  cellEmissive: '#00b487',
  chronoCell: '#b59aff',
  ...
  poisonCreeper: '#215c3a',
  poisonCreeperEmissive: '#0b3d25',
  poisonTrail: '#75df65',
  banger: '#ffb347',
...
export const CAMERA = { fov: 52, near: 0.1, far: 100, angle: 53, landscapeDistance: 8, portraitDistance: 16, followStrength: 0.06 }
export const SCENE = {
  floorMetalness: 0.5,
  floorRoughness: 0.55,
  floorOpacity: 0.76,
...
export const ENTITIES = {
  ...
  magnetPullSpeed: 1.1,
  sporeFuseDuration: 3,
  sporeFragmentCount: 4,
  sporeFragmentChildCount: 4,
  sporeFragmentDuration: 1.35,
  sporeFragmentSpeed: 4.6,
  sporeFragmentScale: 0.42,
  sporeFragmentChildScale: 0.18,
  poisonCreeperTrailInterval: 0.42,
  poisonCreeperTrailRadius: 0.9,
...
export const ANIMATION = {
  ...
  bangerFuseEmissiveBaseIntensity: 0.45,
  bangerFuseEmissivePulseAmount: 0.9,
...
export const ENEMY_TYPES = {
  ...
  poisonCreeper: { color: COLORS.creeper, emissive: COLORS.creeperEmissive, speed: GAME.playerSpeed / 4, range: Infinity },
}
